...
<head>
    ...
    <title>User Report - Kasih Istimewa</title>
    ...
    <div class="max-w-7xl mx-auto report-container border shadow-sm">
        ...
        <div class="p-8 brand-header">
            <div class="flex justify-between">
                <div>
                    ...
                    <p class="text-xl font-bold text-gray-900">User Report</p>
                </div>
                <div class="text-right text-sm text-gray-600">
                    <p>Report ID: USR-REP-{{ date('YmdHis') }}</p>
        ...
        <div class="p-8 executive-summary">
            ...
            <div class="grid grid-cols-2 gap-6">
                <div class="summary-card">
                    <div class="summary-title">User Overview</div>
                    <div class="space-y-3">
                        <div class="flex justify-between">
                        ...
                        <div class="flex justify-between">
                            ...
                            <strong>{{ $inactiveUsers ?? 0 }}</strong>
                        </div>
                        <div class="flex justify-between">
                            <span>New Users (This Month)</span>
                            <strong>{{ $newUsersCount ?? 0 }}</strong>
                        </div>
                    </div>
                </div>
                <div class="summary-card">
                    ...
                    <div class="space-y-3">
                        <div class="flex justify-between">
                            ...
                            <strong>{{ $totalDonations ?? 0 }}</strong>
                        </div>
                        <div class="flex justify-between">
                        ...
                        <div class="flex justify-between">
                            ...
                            <strong>{{ $totalParticipants ?? 0 }}</strong>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <table class="table-report">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $user->user_dob ? \Carbon\Carbon::parse($user->user_dob)->format('d M Y') : '-' }}</td>
                        <td>
                            <span class="">
                                {{ ucfirst($user->user_status ?? 'Inactive') }}
                            </span>
                        </td>
                ...
                <tfoot>
                    <tr class="grand-total-row">
                        ...
                        <td colspan="6">{{ $totalUsers ?? 0 }} Users</td>
                    </tr>
                </tfoot>
            </table>
        </div>
        ...
        <div class="p-8 brand-footer">
            <div class="flex justify-between text-xs text-gray-500">
                <span>
                    Generated by <img src="{{ asset('images/Kasih_Istimewa_Text.png') }}" alt="Kasih Istimewa" style="height:10px; display:inline-block; vertical-align:baseline;"> User Management System
                </span>
                <span>
                    Report ID: USR-REP-{{ date('YmdHis') }}
                </span>
            </div>
