...
<head>
    ...
    <title>Event Created - Kasih Istimewa</title>
    <style>
        body {
...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p>You have successfully created a new event as an admin. The event has been <strong>automatically approved</strong> and is ready for volunteers.</p>
            
            <div style="margin: 10px 0;">
                <span class="admin-badge">👑 Admin Created</span>
                <span class="status-badge" style="margin-left: 10px;">✅ Auto-Approved</span>
            </div>
            ...
            <div class="info-box">
                ...
                <ul>
                    <li>Your event is already approved and visible to volunteers</li>
                    <li>You can publish/unpublish the event anytime</li>
                    <li>Monitor participant registrations through your dashboard</li>
                    <li>You can edit the event details if needed</li>
                </ul>
            </div>
