...
<body>
    <div class="container">
        <div class="header">
            ...
            <p>Event Creation Confirmation</p>
        </div>
        
        <div class="content">
            <h2>Hello, {{ $userName }}!</h2>
            <p>Thank you for creating an event with <strong>Kasih Istimewa</strong>. Your event has been successfully submitted and is now pending admin approval.</p>
            ...
            <div class="info-box">
                ...
                <ul>
                    <li>Our admin team will review your event within 2-3 business days</li>
                    <li>You will receive another email once your event is approved or if changes are needed</li>
                    <li>You can edit your event while it's still pending</li>
                </ul>
            </div>
